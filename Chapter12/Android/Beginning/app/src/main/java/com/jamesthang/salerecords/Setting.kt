        ...
        Box(
            ...
            Column(
                ...
                Button(
                    ...
                    Text("Non-fatal Crash", color = Color.Black)
                }
                ...
                Button(
                    ...
                    Text("RunTime Crash", color = Color.Black)
                }

                Button(
                    onClick = {
                        FirebaseCrashlytics.getInstance().log("User clicked the Logout button")
                ...
                Button(
                    onClick = {
                        FirebaseCrashlytics.getInstance().log("User clicked the Delete user button")
                        when (authMethod) {
                            AuthMethod.EMAIL -> {
...
private fun someFunctionThatMightFail() {
    // Simulate an error
...
@Composable
private fun ReauthenticationEmailPassWord(
                        ...
                        user?.reauthenticate(credential)
                            ?.addOnCompleteListener { task ->
                                if (task.isSuccessful) {
                                    ...
                                    error.value =
                                        task.exception?.message ?: "Reauthentication failed"
                                    onError(error.value)
                                }
                            }
                    }
...
private fun performGoogleReauthentication(
